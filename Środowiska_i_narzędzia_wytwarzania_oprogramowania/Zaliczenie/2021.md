...
- Każdy odpowiada za swoją jedną funkcjonalność, jednak dopuszczalne jest poprawianie kodu w cudzych gałęziach (tylko w ramach własnej grupy), szczególnie, gdy znajdujemy błąd w trakcje code review
